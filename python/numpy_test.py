...
a_numpy_100000 = np.ones((100000), dtype=np.int32)
b_numpy_100000 = np.ones((100000), dtype=np.int32)
c_numpy_100000 = np.ones((100000), dtype=np.int32)
a_b_c_numpy_100000 = np.ones((100000,3), dtype=np.int32)

start_time_section = start_time
for i in range(100000):
    a_numpy_100000 = b_numpy_100000
print(f"numpy:{time.perf_counter()-start_time_section:.5f}s")

start_time_section = start_time
for i in range(100000):
    a_b_c_numpy_100000[:,0] = a_b_c_numpy_100000[:,1]
print(f"numpy 2:{time.perf_counter()-start_time_section:.5f}s")
