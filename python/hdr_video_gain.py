...
print(PQ_EOTF_vectorized(768/1023))
...
path = 'D:\Movies\The.Killer.2023\The.Killer.2023.2160p.WEB-DL.DDP5.1.HDR.H.265.mkv'
path = 'E:\\temp\\Mad.Max.Fury.Road.2015.2160p.UHD.BDRemux.TrueHD.Atmos.DoVi.P8.Hybrid.by.DVT.mkv'
path = 'W:\Movie\Interstellar.2014.2160p.BluRay.REMUX.HEVC.DTS-HD.MA.5.1-FGT\Interstellar.2014.2160p.BluRay.REMUX.HEVC.DTS-HD.MA.5.1-FGT.mkv'
path = 'C:\\temp\\2001.A.Space.Odyssey.1968.2160p.UHD.BluRay.X265-IAMABLE\\2001.A.Space.Odyssey.1968.2160p.UHD.BluRay.X265-IAMABLE.mkv'
path = 'C:\\temp\\Dune.Part.Two.2024.2160p.BluRay.REMUX.DV.HDR.ENG.LATINO.DDP5.1.H265.MP4-BEN.THE.MEN.mp4'
...
output_container = av.open('D:\Movies\The.Killer.2023\The.Killer.2023.2160p.WEB-DL.DDP5.1.HDR.H.265.2xgain.mkv', 'w')
output_container = av.open('C:\\temp\\Mad.Max.Fury.Road.2015.2160p.UHD.BDRemux.TrueHD.Atmos.DoVi.P8.Hybrid.by.DVT.0.65xgain.mkv', 'w')
output_container = av.open('W:\Movie\Interstellar.2014.2160p.BluRay.REMUX.HEVC.DTS-HD.MA.5.1-FGT\Interstellar.2014.2160p.BluRay.REMUX.HEVC.DTS-HD.MA.5.1-FGT.1.45xgain.mkv', 'w')
output_container = av.open('E:\\temp\\2001.A.Space.Odyssey.1968.2160p.UHD.BluRay.X265-IAMABLE.mkv.1.6xgain.mkv', 'w')
output_container = av.open('C:\\temp\\Dune.Part.Two.2024.2160p.BluRay.REMUX.DV.HDR.ENG.LATINO.DDP5.1.H265.MP4-BEN.THE.MEN.2xgain.mkv', 'w')
...
output_stream.options = {'preset':'0','crf':'11','r':'23.976'}
