...
#CIE_XYZ to sRGB
sRGB_linear[0] =  3.2404542*CIE_XYZ[0] -1.5371385*CIE_XYZ[1] -0.4985314*CIE_XYZ[2]
sRGB_linear[1] = -0.9692660*CIE_XYZ[0] +1.8760108*CIE_XYZ[1] +0.0415560*CIE_XYZ[2]
sRGB_linear[2] =  0.0556434*CIE_XYZ[0] -0.2040259*CIE_XYZ[1] +1.0572252*CIE_XYZ[2]
...
CIE_XYZ[0] = 0.4124564*sRGB_linear[0] +0.3575761*sRGB_linear[1] +0.1804375*sRGB_linear[2]
CIE_XYZ[1] = 0.2126729*sRGB_linear[0] +0.7151522*sRGB_linear[1] +0.0721750*sRGB_linear[2]
CIE_XYZ[2] = 0.0193339*sRGB_linear[0] +0.1191920*sRGB_linear[1] +0.9503041*sRGB_linear[2]
