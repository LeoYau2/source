...
int main(int argc, char *argv[]){
    ...
    if (argc == 4) {
        ...
        std::cerr << "Usage: " << argv[0] << " [input_path] [out]put_path] [sample_frequency]" << std::endl;
    ...
    if(found_file){
        ...
        //data[56] = sample_frequency[0] % 256;
        //data[57] = sample_frequency[0] / 256;
        //data[58] = sample_frequency[0] / 65536;
        //data[59] = sample_frequency[0] / 16777216;
        output_file.write(reinterpret_cast<const char*>(data), filesize);
        output_file.seekp(56, ios::beg);
