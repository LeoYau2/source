...
void pricess_frame(unsigned short* input, unsigned short* output, int frame_count, int width, int height, int yuv_size, int u_size, int v_size, float gain, float* PQ_gain_table_10bit){
...
int main(int argc, char *argv[]){
    ...
    if(found_file){
        ...
        unsigned short* output_data = new unsigned short[yuv_size*total_frame_count];
